...
Public Function frmDefaultAfterUpdate(frm As Form, ModelID)
...
Public Function frmDefaultOnUnload(frm As Form, ModelID)
...
Public Function frmDefaultOnCurrent(frm As Form, ModelID)
