...
Public Function GoToNewRecord(frm As Form, Optional RemoveFocusArgs As String = "") As Boolean
...
Public Function GoToSpecificRecord(frm As Form, ByVal recordNumber As Long, Optional AllowAddition As Boolean = True, Optional Caption = "position")
...
Public Function txtRecordNumber_AfterUpdate(frm As Form, Optional AllowAddition = False, Optional Caption = "position")
...
Public Function SetNavigationData(frm As Form, Optional AdditionAllowed As Boolean = True, Optional PerformRequery As Boolean = False, Optional Caption = "position")
...
Public Function DeleteSubformRecord(frm As Form, Optional RemoveFocusArgs As String = "")
...
Private Function RemoveFocusFromSubform(frm As Form, RemoveFocusArgs As String)
...
Public Function GoToNextRecord(frm As Form, Optional AllowAddition As Boolean = True, Optional RemoveFocusArgs As String = "", Optional Caption = "position")
...
Public Function GoToPreviousRecord(frm As Form, Optional AllowAddition As Boolean = True, Optional RemoveFocusArgs As String = "", Optional Caption = "position")
