...
Public Function FindFirst(frm As Form, condition As String) As Boolean
...
Public Function SetDefaultValueFromTable(frm As Form, tblName, idField, fieldToMatch, valueToMatch)
...
Public Function StrictSave(frm As Form, Model, Operation)
...
Public Function SetFocusOnForm(frm As Form, ctlName)
    On Error Resume Next
