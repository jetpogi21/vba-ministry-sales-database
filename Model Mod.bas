...
Public Function GetTableName(Model, Optional VerbosePlural, Optional QueryName = Null, Optional forceTable As Boolean = False) As String
    ...
    ''Get ModelID of the Model
    Dim ModelID: ModelID = ELookup("tblModels", "Model = " & EscapeString(Model), "ModelID")
    If ModelID <> "" Then
...
Public Function SaveFormData2(frm As Form, Model As String, Optional CancelOnClose As Boolean = False) As Boolean
...
Public Function CreateTableDef(frm As Form, Optional notifySuccess As Boolean = True)
...
NextField:
    ...
    Do Until rs.EOF
        ...
        If Not DoesPropertyExists(frm, "tabCtl") Then
            ...
            Dim tabCtlHeight: tabCtlHeight = 3500
...
Private Sub RenderAdditionalButtonOnDEForm(ModelID, frm As Object, y, x, CurrentCol, buttonMultiplier, FormColumns)
    ...
    If Not rs.EOF Then
        ...
        ElseIf isPresent("qryModelProperties", "ModelID = " & ModelID & " And Property = " & EscapeString("listboxButtonOnForm")) Then
            ...
            ''RenderListBoxButton(frm As Form, ControlCreationHelperID, Optional xPosition, Optional parentFormName)
...
Public Sub RenderCheckboxAndLabel(frm As Form, ctlName, optionValue As Integer, optionText As String, x, y, totalWidth As Integer)
    Dim ctl As control
    ''Render the checkbox
...
Private Sub RenderBasedOnPossibleValues(frm As Form, ctlName, xPosition, totalWidth, possibleValues, parent, ctlType, Direction, proportion)
...
Private Sub RenderCheckboxListFilterControls(frm As Form, ctlName, xPosition, totalWidth, FilterFieldID, Optional optionGroupMode As Boolean = False)
...
Private Sub RenderCheckboxListFilterForm(frm As Form, ctlName, xPosition, totalWidth, FilterFieldID, Optional optionGroupMode As Boolean = False)
...
Private Sub CreateFilterContForm(ctlName, VerboseName, optionGroupMode, sqlStr, ModelName)
    ...
    ''FilterContFormOnLoad(frm As Form, sqlStr As String, tblName As String)
...
Private Sub RenderFilterForm(frm As Form, ModelID, Optional DataEntryMode As Boolean = False, Optional frmName As String = "")
...
Public Function FilterFilterSubform(frm As Form, searchBoxName, SubformName)
...
Public Function ClearFilterFilterSubform(frm As Form, searchBoxName, SubformName)
...
Public Function SeedTable(frm As Form, Optional ModelID = "", Optional UpdateMode As Boolean = False, Optional recordSize = 50, Optional notify As Boolean = True)
...
Public Function UpdateSeed(frm As Form, Optional ModelID = "")
...
Public Function CreateSelectorForm(frm As Form, Optional ModelID = "")
...
Public Function SelectRecordFromSelector(frm As Form, TargetForm, RecordIDName, DropdownName, AfterUpdateCallback)
...
Public Function CreateSingleRecordReport(frm As Form, Optional ModelID = "")
