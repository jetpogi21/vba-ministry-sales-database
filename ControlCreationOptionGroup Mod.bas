...
Public Function SetOptionGroupValue(frm As Form, FieldToUse, ogName)
...
Public Function OGControlAfterUpdate(frm As Form, FieldToUse, ogName)
...
Private Sub RepositionOptionOptionGroupParent(frm As Form, ogName, firstObName)
...
Private Sub RepositionOptionGroup(frm As Form, ControlNames As clsArray, x, lblName)
...
Private Sub RenderOGBasedOnPossibleValues(frm As Form, ogName, ControlNames As clsArray, firstObName)
...
Private Sub RenderIndividualOptionButton(frm As Form, opt, ogName, optionValue, ControlNames As clsArray, firstObName)
...
Private Sub RenderOg(frm As Form, ogName, x)
...
Private Sub RenderOGLabel(frm As Form, ogName, x, lblName)
