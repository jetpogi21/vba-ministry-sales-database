...
Public Function FilterContOptionOnChange(frm As Form, tblName, Optional FieldToUse)
...
Public Function FilterContFormOnLoad(frm As Form, sqlStr As String, tblName As String)
...
Public Function SetSubformCaption(frm As Form, tblName, subformLabelName)
...
Public Function ToggleFilterCB(frm As Form, tblName, Optional FieldToUse)
