...
Public Function SetFilePath(frm As Form, FileType As String, fieldName)
...
Public Function SelectDEDirectory(frm As Form, fldName, Optional AdditionalTrigger = Null)
...
Function OpenFileWithDefaultProgram(filePath As String) As Boolean
    On Error Resume Next
