...
Public Function MainFormSQLOnLoad(frm As Form, ModelID)
...
Public Function SetSubformSQL(frm As Form, ModelID)
...
Private Function GetSQLAndJoins(frm As Form, ModelID, sqlObj)
...
Private Function GetFilterValues(frm As Form, SubformName) As clsArray
