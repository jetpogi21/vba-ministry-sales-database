...
Public Function LoopFunctionCreator_ModelID_OnChange(frm As Form, Optional parentMode As Boolean = True)
...
'Public Function CreateALoopFunction(frm As Form, Optional LoopFunctionCreatorID = "")
'
...
Public Function LoopFunctionCreator_CreateChildFunction(frm As Form, Optional LoopFunctionCreatorID = "", Optional notify = True)
