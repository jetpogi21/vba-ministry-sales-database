...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Public Sub RenderFromToTextbox(frm As Form, ControlCreationHelperID)
...
Public Function ValidateFromToTextbox(frm As Form, ctlName)
...
Public Function RenderListBoxButton(frm As Form, ControlCreationHelperID, Optional xPosition, Optional parentFormName)
...
Public Function RunFunctionFromListButton(frm As Form, ListName)
...
Public Function ClearCustomListBoxFilter(frm As Form, Model)
...
Public Function FilterCustomListbox(frm As Form, Model)
...
'    CopyProperties frm, lblName, "FilterLabelControl", False
    ...
    ctl.Name = addBtnName
    ctl.Caption = "Add"
    ''AddToFilterList(frm As Form, searchBoxName, SubformName, Model)
...
Public Function AddToFilterList(frm As Form, searchBoxName, SubformName, Model)
...
Public Function SetFormSingleValue(frm As Form, FieldToUse)
...
Public Function SetMiddleTableValues(frm As Form, MiddleTable, tblName, FieldToUse, ParentModel)
...
Public Function SetSubformCheck(frm As Form, ParentModel, SubformName, MiddleTable, FieldToUse)
...
Public Function ToggleSubformCheckboxes(frm As Form, SubformName)
...
Public Function CreateNamedControl(frm As Form, ControlType As AcControlType, labelName, Optional parent) As control
